...
public class EmployeeValidator {
	...
	public static List<String> validate (EmployeeService service, EmployeeView ev, Boolean codeDublicateCheckFlag, Boolean passwordCheckFlag) {

		List<String> errors = new ArrayList<String>();

		// 社員番号のチェック
		String codeError = validateCode(service, ev.getCode(), codeDublicateCheckFlag);
		if (!codeError.equals("")) {
